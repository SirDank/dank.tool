...
from dankware import white, white_normal, green, green_normal, green_dim
...
def main():
    ...
    cls(); print(align(clr(banner1,4,colours=[white, white_normal, green, green_normal, green_dim]) + align(clr('+')) + align(clr(banner2,4,colours=[white, white_normal, green, green_normal, green_dim]))))
    ...
    while True:
        ...
        try:
            ...
            os.system('start cmd.exe @cmd /k "spicetify backup apply"') # restore
            break
