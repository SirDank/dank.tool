...
def generate_ip_targetted():
    while True:
        ip = choice(target_ips, p=target_weights) + f".{randint(0,255)}.{randint(0,255)}"
        if ip in ips.keys(): continue
        ips[ip] = ""; break        
...
if __name__ == "__main__": 
    ...
    if "DANK_TOOL_VERSION" in os.environ:
        for _ in ('ips', 'server_type', 'port', 'executor', 'translator', 'check_java', 'check_bedrock', 'save_server', 'generate_ip', 'generate_ip_targetted', 'target_ips', 'target_weights', 'main', 'translate'):
