...
def save_server(ip):
    ...
    try:
        ...
        for err in ["WinError 10054", "WinError 10061", "WinError 10053", "timed out", "unreachable", "refused", "not valid", "invalid", "closed", "did not", "aborted", "failed", "no route", "No route", "Broken pipe", "fermé", "refusée", "abandonnée", "Not enough data to read"]:
            if err in exc:
