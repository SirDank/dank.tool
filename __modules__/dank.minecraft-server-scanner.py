    ...
    while gen_rem > 0:
        ...
        while True:
            try:
                ...
                if server_type == "java": multithread(check_java, threads, tuple(ips.keys(), progress_bar=not ('COMPATIBILITY-MODE' in os.environ))); break
                if server_type == "bedrock": multithread(check_bedrock, threads, tuple(ips.keys(), progress_bar=not ('COMPATIBILITY-MODE' in os.environ))); break
